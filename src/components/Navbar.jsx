    ...
    <>
      ...
      >
        <img
          ...
          alt="logo"
          className="h-28 no-filter drop-shadow-[0_0_28px_rgba(32,150,166,0.5)]"
        />
      </motion.div>
      ...
      <nav className="fixed top-0 left-0 right-0 flex flex-col items-center z-50 pointer-events-none pt-3">
        ...
        >
          <img
            src={`${import.meta.env.BASE_URL}images/etc/logo.png`}
            alt="logo"
            className="h-15 no-filter drop-shadow-[0_0_20px_rgba(32,150,166,0.5)]"
          />
        </motion.div>
          ...
          <div
            ...
            style={{
              background: scrolled
                ? "hsl(200 14% 18% / 0.97)"
                : "hsl(200 14% 20% / 0.80)",
              border: "1px solid hsl(188 68% 39% / 0.28)",
              boxShadow: scrolled
                ? "0 6px 28px hsl(200 20% 6% / 0.55), 0 1px 0 hsl(188 68% 39% / 0.18) inset"
                : "0 2px 16px hsl(200 20% 6% / 0.30)",
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      style={{
                        ...
                        boxShadow: "0 0 14px hsl(188 68% 39% / 0.5), 0 2px 8px hsl(188 65% 20% / 0.4)",
                      }}
                  ...
                  <span
                    ...
                    style={{
                      color: isActive
                        ? "hsl(0 0% 98%)"              /* blanco sobre turquesa */
                        : "hsl(200 14% 68%)",           /* gris claro inactivo   */
                    }}
                  >
                    {link.name}
                  </span>
